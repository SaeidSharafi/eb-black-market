        ...
        @if ($isConnected)
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="text-sm">
                        ...
                        <p class="text-gray-500">
                            {{
                                __(
                                    "resources.filament-widgets.connect-telegram-banner.connected"
                                )
                            }}
                        </p>
                    </div>
                ...
                <div class="telegram-widget-container">
                    <div id="telegram-login-widget" class="telegram-login-widget-container">
                        <a
                        ...
                        >
                            {{__('resources.filament-widgets.connect-telegram-banner.open_telegram_bot')}}
