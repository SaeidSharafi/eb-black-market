@php use Illuminate\Support\Facades\Auth; @endphp @extends('layouts.app')
@section('content')
<!-- Hero Section -->
<header class="relative text-white text-center py-24 md:py-32 bg-gray-800">
    <div
...
<main id="latest-listings" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
