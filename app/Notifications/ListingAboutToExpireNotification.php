...
class ListingAboutToExpireNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toTelegram(object $notifiable)
    {
        ...
        return TelegramMessage::create()
            ...
            ->line(__('notifications.listing_about_to_expire.title',[],$lang))
            ->line(
                __('notifications.listing_about_to_expire.message', [
                    'item' => $this->listing->item->getTranslation('name', $lang),
                    'time' => now()->diffForHumans($this->listing->updated_at->addDays(3), CarbonInterface::DIFF_ABSOLUTE)
                ], $lang)
            )
